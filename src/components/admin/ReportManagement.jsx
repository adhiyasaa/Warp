        ...
        >
                            ...
                            >
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <select 
                                        ...
                                        className={`p-2 rounded-md text-sm font-medium ${statusColors[report.status] || 'bg-gray-100 text-gray-800'}`}
                                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                    <div className="text-blue-800 font-medium">Menunggu Verifikasi</div>
                    <div className="text-2xl font-bold text-blue-600">
                        {reports.filter(r => r.status === 'Menunggu Verifikasi').length}
                    </div>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                    <div className="text-yellow-800 font-medium">Sedang Diproses</div>
