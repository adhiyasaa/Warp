...
import { FaBullseye, FaUsers, FaLightbulb, FaChartLine, FaHandsHelping } from 'react-icons/fa';
  ...
  >
    ...
    <div className="mt-4 flex justify-center space-x-4">
      ...
      <a href="#" className="text-gray-500 hover:text-pink-600 transition-colors">
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path fillRule="evenodd" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919 1.266-.058 1.644-.07 4.85-.07zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948s.014 3.667.072 4.947c.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072s3.667-.014 4.947-.072c4.358-.2 6.78-2.618 6.98-6.98.059-1.281.073-1.689.073-4.948s-.014-3.667-.072-4.947c-.2-4.358-2.618-6.78-6.98-6.98-1.281-.059-1.689-.073-4.948-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.79 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44 1.441-.645 1.441-1.44-.645-1.44-1.441-1.44z" clipRule="evenodd" />
        </svg>
      </a>
    </div>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <header className="relative text-white text-center py-32 bg-gradient-to-r from-blue-900 to-blue-700 overflow-hidden">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 drop-shadow-lg">Tentang LaporCepat</h1>
          <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Memberdayakan Warga, Membangun Kota. Inisiatif dari Malang untuk Indonesia.
          </p>
        </motion.div>
      </header>
      ...
      <main className="container mx-auto px-4 py-16 -mt-16">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white shadow-xl">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div className="p-4">
                ...
                <div className="text-blue-200">Jam Respon</div>
              </div>
              <div className="p-4">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <TeamMember 
              name="Muhammad Adhiyasa" 
              role="Fullstack Developer" 
              imageUrl="/images/adhiyasa.jpg"
              delay={0.1}
            />
            <TeamMember 
              name="Varel Antoni" 
              role="Machine Learning Developer" 
              imageUrl="/images/varel.jpg"
              delay={0.3}
            />
            <TeamMember 
              name="Rivaro Farrelino" 
              role="Machine Learning Developer" 
              imageUrl="/images/rivaro.jpg"
              delay={0.5}
            />
          </div>
        </motion.section>
